      ...
      <div className="container mx-auto relative z-10">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8 animate-fade-in">
            <div className="space-y-6">
              ...
              <p className="text-lg text-gray-700 leading-relaxed">
                ...
                intersection of <span className="text-rose-500 font-medium">Ayurveda</span>, 
                <span className="text-lavender-500 font-medium"> Yoga</span>, and 
                <span className="text-peach-500 font-medium"> Technology</span>. 
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              <Card className="feminine-card p-6 text-center group hover:scale-105 transition-transform duration-300">
                ...
                <p className="text-sm text-gray-600">Technology with heart and humanity</p>
              </Card>
              ...
              <Card className="feminine-card p-6 text-center group hover:scale-105 transition-transform duration-300">
                ...
                <p className="text-sm text-gray-600">Bridging ancient and modern wisdom</p>
              </Card>
              
              <Card className="feminine-card p-6 text-center group hover:scale-105 transition-transform duration-300">
                <Book className="w-8 h-8 text-peach-500 mx-auto mb-3 group-hover:animate-float" />
                <h4 className="font-semibold text-gray-800 mb-2">Learning</h4>
                <p className="text-sm text-gray-600">Continuous growth and knowledge sharing</p>
              </Card>
            </div>
          </div>
          ...
          <div className="space-y-8 animate-slide-in">
            <Card className="feminine-card p-8 relative overflow-hidden">
              ...
              <div className="relative">
                ...
                <blockquote className="text-lg text-gray-700 italic leading-relaxed text-center space-y-4">
                  <p>
            ...
            {/* Fun Facts */}
            <Card className="feminine-card p-6">
